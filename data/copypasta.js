export default [
  {
    text: 'Lorem',
    description: `A copypasta is a block of text which is copied and pasted across the
    ...
    external: [
      {
        text: 'External',
        url:
          'https://en.wikipedia.org/wiki/Copypasta#:~:text=A%20copypasta%20is%20a%20block,to%20be%20similar%20to%20spam.'
      },
      {
        text: 'Same',
        url:
  ...
  {
    text:
      '𝘒𝘰𝘮𝘦𝘯𝘵𝘢𝘳 𝘪𝘯𝘪 𝘵𝘦𝘭𝘢𝘩 𝘥𝘪𝘩𝘢𝘱𝘶𝘴 𝘰𝘭𝘦𝘩 𝘋𝘪𝘷𝘪𝘴𝘪 𝘗𝘰𝘭𝘪𝘴𝘪 𝘊𝘺𝘣𝘦𝘳 𝘐𝘯𝘥𝘰𝘯𝘦𝘴𝘪𝘢 𝘬𝘢𝘳𝘦𝘯𝘢 𝘮𝘦𝘮𝘶𝘢𝘵 𝘶𝘫𝘢𝘳𝘢𝘯 𝘬𝘦𝘣𝘦𝘯𝘤𝘪𝘢𝘯 𝘥𝘢𝘯 𝘵𝘦𝘭𝘢𝘩 𝘮𝘦𝘭𝘢𝘯𝘨𝘨𝘢𝘳 𝘗𝘢𝘴𝘢𝘭 28 𝘢𝘺𝘢𝘵 (2) 𝘜𝘜 𝘐𝘛𝘌',
    tags: ['UUITE', 'polisi', 'cyber'],
    language: 'id'
  },
  {
    text: `NGAKAK BESAR 
    ...
    𝒏𝒈𝒂𝒌𝒂𝒌 𝒂𝒆𝒔𝒕𝒉𝒆𝒕𝒊𝒄
    ʞılɐqǝʞ ʞɐʞɐɓu
    n̶g̶a̶k̶a̶k̶ ̶t̶a̶p̶i̶ ̶g̶a̶j̶a̶d̶i̶
    nGaKaK bErGeLoMbaNg 
    ᘉᘜᗩᖽᐸᗩᖽᐸ ᗷᘿᖇᘻÖᖶᓰᖴ
    🄽🄶🄰🄺🄰🄺🄱🄴🅁🄺🄾🅃🄰🄺 
    ⓝⓖⓐⓚⓐⓚⓑⓔⓡⓑⓤⓛⓐⓣ
    n g a k a k   s o s i a l d i s t e n s i n g`,
    tags: ['ngakak', 'bengek'],
    language: 'id'
  },
  {
        ...
        🍞🍞🍞🍞🍞🍞🍞🍞🍞
             🍞🍞🍞🍞🍞🍞🍞
                  🍞🍞🍞🍞🍞
                       🍞🍞🍞
                             🍞`,
    tags: ['roti', 'iyamas', 'emoji'],
    language: 'id'
  },
  {
    text: `mmf aku ⁿᵍᵃᵏᵃᵏ ᵏᵉᶜⁱˡ, ngakak sedang, NGAKAK BESAR, nGakAk bERgeLomBAng, Π94Ƙ4Ƙ 4£4¥, 🄽🄶🄰🄺🄰🄺 🄺🄾🅃🄰🄺, 🅝🅖🅐🅚🅐🅚 🅑🅤🅛🅐🅣, nƃɐʞɐʞ ʇǝɹbɐlıʞ, ̶n̶̶g̶̶a̶̶k̶̶a̶̶k̶ ̶t̶̶e̶̶r̶̶l̶̶a̶̶r̶̶a̶̶n̶̶g̶,  𝓃ℊ𝒶𝓀𝒶𝓀 𝓂𝒾𝓇𝒾𝓃ℊ, ∘⿴⃟͜᷼ngαkαk αєstєtík᎒⃟❒۪۪༘∘😭😭`,
    tags: ['ngakak', 'bengek'],
    language: 'id'
  },
  {
    text: 'ⓘ 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝘀𝗼𝘂𝗿𝗰𝗲𝘀 𝘀𝘁𝗮𝘁𝗲𝗱 𝘁𝗵𝗮𝘁 𝘁𝗵𝗶𝘀 𝗶𝘀 𝗳𝗮𝗹𝘀𝗲 𝗮𝗻𝗱 𝗺𝗶𝘀𝗹𝗲𝗮𝗱𝗶𝗻𝗴',
    tags: ['twitter', 'hoax', 'misleading'],
    language: 'id'
  },
  {
    text: `动态网自由门 天安門 天安门 法輪功 李洪志 Free Tibet 六四天安門事件 The Tiananmen Square protests of 1989 天安門大屠殺 The Tiananmen Square Massacre 反右派鬥爭 The Anti-Rightist Struggle 大躍進政策 The Great Leap Forward 文化大革命 The Great Proletarian Cultural Revolution 人權 Human Rights 民運 Democratization 自由 Freedom 獨立 Independence 多黨制 Multi-party system 台灣 臺灣 Taiwan Formosa 中華民國 Republic of China 西藏 土伯特 唐古特 Tibet 達賴喇嘛 Dalai Lama 法輪功 Falun Dafa 新疆維吾爾自治區 The Xinjiang Uyghur Autonomous Region 諾貝爾和平獎 Nobel Peace Prize 劉暁波 Liu Xiaobo 民主 言論 思想 反共 反革命 抗議 運動 騷亂 暴亂 騷擾 擾亂 抗暴 平反 維權 示威游行 李洪志 法輪大法 大法弟子 強制斷種 強制堕胎 民族淨化 人體實驗 肅清 胡耀邦 趙紫陽 魏京生 王丹 還政於民 和平演變 激流中國 北京之春 大紀元時報 九評論共産黨 獨裁 專制 壓制 統一 監視 鎮壓 迫害 侵略 掠奪 破壞 拷問 屠殺 活摘器官 誘拐 買賣人口 遊進 走私 毒品 賣淫 春畫 賭博 六合彩 天安門 天安门 法輪功 李洪志 Winnie the Pooh 劉曉波动态网自由门`,
    tags: ['tianmen'],
    language: ['en', 'zh']
  },
  {
